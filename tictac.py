...
def checkforwin():
    ...
    for condition in win_conditions:
        if condition[0]['text'] == "x" and condition[1]['text'] == "x" and condition[2]['text'] == "x":
            disableButton()
            playerA.set(p1.get() + " wins!")
            tkinter.messagebox.showinfo("Tic Tac Toe", playerA.get())
            return

    # Check for 'o' win
    for condition in win_conditions:
        if condition[0]['text'] == "o" and condition[1]['text'] == "o" and condition[2]['text'] == "o":
            disableButton()
            playerB.set(p2.get() + " wins!")
            tkinter.messagebox.showinfo("Tic Tac Toe", playerB.get())
            return
